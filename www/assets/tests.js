...
define('ember-sugar/tests/lint/app.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | app');

  QUnit.test('adapters/deletelead.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/deletelead.js should pass ESLint\n\n');
  });

  QUnit.test('adapters/generic.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'adapters/generic.js should pass ESLint\n\n6:12 - Use import { computed } from \'@ember/object\'; instead of using Ember.computed (ember/new-module-imports)\n6:12 - \'Ember\' is not defined. (no-undef)');
  });

  QUnit.test('adapters/insertlead.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/insertlead.js should pass ESLint\n\n');
  });

  QUnit.test('adapters/lead.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/lead.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('controllers/login-page.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/login-page.js should pass ESLint\n\n5:9 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)\n24:11 - Unexpected \'debugger\' statement. (no-debugger)\n27:25 - \'error\' is defined but never used. (no-unused-vars)\n28:11 - Unexpected \'debugger\' statement. (no-debugger)');
  });

  QUnit.test('models/deletelead.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/deletelead.js should pass ESLint\n\n');
  });

  QUnit.test('models/insertlead.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/insertlead.js should pass ESLint\n\n');
  });

  QUnit.test('models/lead.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/lead.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/deletelead.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/deletelead.js should pass ESLint\n\n7:11 - \'deletion\' is assigned a value but never used. (no-unused-vars)\n17:23 - \'err\' is defined but never used. (no-unused-vars)');
  });
  ...
  QUnit.test('routes/insertlead.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/insertlead.js should pass ESLint\n\n21:7 - Do not use global `$` or `jQuery` (ember/no-global-jquery)\n21:7 - \'$\' is not defined. (no-undef)');
  });

  QUnit.test('routes/leads.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/leads.js should pass ESLint\n\n5:59 - \'err\' is defined but never used. (no-unused-vars)');
  });

  QUnit.test('routes/login-page.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/login-page.js should pass ESLint\n\n');
  });

  QUnit.test('serializers/deletelead.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'serializers/deletelead.js should pass ESLint\n\n9:3 - Use import { assign } from \'@ember/polyfills\'; instead of using Ember.assign (ember/new-module-imports)\n9:3 - \'Ember\' is not defined. (no-undef)');
  });

  QUnit.test('serializers/insertlead.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'serializers/insertlead.js should pass ESLint\n\n9:3 - Use import { assign } from \'@ember/polyfills\'; instead of using Ember.assign (ember/new-module-imports)\n9:3 - \'Ember\' is not defined. (no-undef)');
  });

  QUnit.test('serializers/lead.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'serializers/lead.js should pass ESLint\n\n2:8 - \'Ember\' is defined but never used. (no-unused-vars)');
  });
});
define('ember-sugar/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('ember-sugar/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-sugar/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ember-sugar/templates/deletelead.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-sugar/templates/deletelead.hbs should pass TemplateLint.\n\nember-sugar/templates/deletelead.hbs\n  11:7  error  Incorrect indentation for `div` beginning at L2:C2. Expected `</div>` ending at L11:C7 to be at an indentation of 2 but was found at 1.  block-indentation\n  3:3  error  Incorrect indentation for `<div>` beginning at L3:C3. Expected `<div>` to be at an indentation of 4 but was found at 3.  block-indentation\n  6:3  error  Incorrect indentation for `<ul>` beginning at L6:C3. Expected `<ul>` to be at an indentation of 4 but was found at 3.  block-indentation\n  24:7  error  Incorrect indentation for `form` beginning at L17:C2. Expected `</form>` ending at L24:C7 to be at an indentation of 2 but was found at 0.  block-indentation\n  18:2  error  Incorrect indentation for `<br>` beginning at L18:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  19:2  error  Incorrect indentation for `<h4>` beginning at L19:C2. Expected `<h4>` to be at an indentation of 4 but was found at 2.  block-indentation\n  20:2  error  Incorrect indentation for `{{input}}` beginning at L20:C2. Expected `{{input}}` to be at an indentation of 4 but was found at 2.  block-indentation\n  21:2  error  Incorrect indentation for `<br>` beginning at L21:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  22:2  error  Incorrect indentation for `<br>` beginning at L22:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  23:2  error  Incorrect indentation for `<button>` beginning at L23:C2. Expected `<button>` to be at an indentation of 4 but was found at 2.  block-indentation\n  7:12  error  Interaction added to non-interactive element  no-invalid-interactive\n  8:12  error  Interaction added to non-interactive element  no-invalid-interactive\n  23:43  error  you must use double quotes in templates  quotes\n  18:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  21:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  22:2  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('ember-sugar/templates/insertlead.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-sugar/templates/insertlead.hbs should pass TemplateLint.\n\nember-sugar/templates/insertlead.hbs\n  11:7  error  Incorrect indentation for `div` beginning at L2:C2. Expected `</div>` ending at L11:C7 to be at an indentation of 2 but was found at 1.  block-indentation\n  3:3  error  Incorrect indentation for `<div>` beginning at L3:C3. Expected `<div>` to be at an indentation of 4 but was found at 3.  block-indentation\n  6:3  error  Incorrect indentation for `<ul>` beginning at L6:C3. Expected `<ul>` to be at an indentation of 4 but was found at 3.  block-indentation\n  17:2  error  Incorrect indentation for `<br>` beginning at L17:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  18:2  error  Incorrect indentation for `<h4>` beginning at L18:C2. Expected `<h4>` to be at an indentation of 4 but was found at 2.  block-indentation\n  19:2  error  Incorrect indentation for `{{input}}` beginning at L19:C2. Expected `{{input}}` to be at an indentation of 4 but was found at 2.  block-indentation\n  20:2  error  Incorrect indentation for `<br>` beginning at L20:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  21:2  error  Incorrect indentation for `<br>` beginning at L21:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  22:2  error  Incorrect indentation for `<h4>` beginning at L22:C2. Expected `<h4>` to be at an indentation of 4 but was found at 2.  block-indentation\n  23:2  error  Incorrect indentation for `{{input}}` beginning at L23:C2. Expected `{{input}}` to be at an indentation of 4 but was found at 2.  block-indentation\n  24:2  error  Incorrect indentation for `<br>` beginning at L24:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  25:2  error  Incorrect indentation for `<br>` beginning at L25:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  26:2  error  Incorrect indentation for `<h4>` beginning at L26:C2. Expected `<h4>` to be at an indentation of 4 but was found at 2.  block-indentation\n  27:2  error  Incorrect indentation for `{{input}}` beginning at L27:C2. Expected `{{input}}` to be at an indentation of 4 but was found at 2.  block-indentation\n  28:2  error  Incorrect indentation for `<br>` beginning at L28:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  29:2  error  Incorrect indentation for `<br>` beginning at L29:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  30:2  error  Incorrect indentation for `<h4>` beginning at L30:C2. Expected `<h4>` to be at an indentation of 4 but was found at 2.  block-indentation\n  31:2  error  Incorrect indentation for `{{input}}` beginning at L31:C2. Expected `{{input}}` to be at an indentation of 4 but was found at 2.  block-indentation\n  32:2  error  Incorrect indentation for `<br>` beginning at L32:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  33:2  error  Incorrect indentation for `<br>` beginning at L33:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  34:2  error  Incorrect indentation for `<h4>` beginning at L34:C2. Expected `<h4>` to be at an indentation of 4 but was found at 2.  block-indentation\n  35:2  error  Incorrect indentation for `{{input}}` beginning at L35:C2. Expected `{{input}}` to be at an indentation of 4 but was found at 2.  block-indentation\n  36:2  error  Incorrect indentation for `<br>` beginning at L36:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  37:2  error  Incorrect indentation for `<br>` beginning at L37:C2. Expected `<br>` to be at an indentation of 4 but was found at 2.  block-indentation\n  38:2  error  Incorrect indentation for `<button>` beginning at L38:C2. Expected `<button>` to be at an indentation of 4 but was found at 2.  block-indentation\n  7:12  error  Interaction added to non-interactive element  no-invalid-interactive\n  9:12  error  Interaction added to non-interactive element  no-invalid-interactive\n  38:43  error  you must use double quotes in templates  quotes\n  17:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  20:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  21:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  24:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  25:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  28:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  29:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  32:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  33:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  36:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  37:2  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('ember-sugar/templates/leads.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-sugar/templates/leads.hbs should pass TemplateLint.\n\nember-sugar/templates/leads.hbs\n  11:7  error  Incorrect indentation for `div` beginning at L2:C2. Expected `</div>` ending at L11:C7 to be at an indentation of 2 but was found at 1.  block-indentation\n  3:3  error  Incorrect indentation for `<div>` beginning at L3:C3. Expected `<div>` to be at an indentation of 4 but was found at 3.  block-indentation\n  6:3  error  Incorrect indentation for `<ul>` beginning at L6:C3. Expected `<ul>` to be at an indentation of 4 but was found at 3.  block-indentation\n  30:6  error  Incorrect indentation for `<tr>` beginning at L30:C6. Expected `<tr>` to be at an indentation of 8 but was found at 6.  block-indentation\n  8:12  error  Interaction added to non-interactive element  no-invalid-interactive\n  9:12  error  Interaction added to non-interactive element  no-invalid-interactive\n');
  });

  QUnit.test('ember-sugar/templates/login-page.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-sugar/templates/login-page.hbs should pass TemplateLint.\n\nember-sugar/templates/login-page.hbs\n  1:5  error  Incorrect indentation of htmlAttribute \'width\' beginning at L1:C5. Expected \'width\' to be at L2:C2.  attribute-indentation\n  1:19  error  Incorrect indentation of htmlAttribute \'align\' beginning at L1:C19. Expected \'align\' to be at L3:C2.  attribute-indentation\n  1:34  error  Incorrect indentation of htmlAttribute \'style\' beginning at L1:C34. Expected \'style\' to be at L4:C2.  attribute-indentation\n  1:80  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L1:C80. Expected \'<div>\' to be at L5:C0.  attribute-indentation\n  1:34  error  elements cannot have inline styles  no-inline-styles\n');
  });
});
define('ember-sugar/tests/lint/tests.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('unit/controllers/login-page-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/login-page-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/deletelead-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/deletelead-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/insertlead-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/insertlead-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/leads-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/leads-test.js should pass ESLint\n\n');
  });
...
define('ember-sugar/tests/test-helper', ['ember-sugar/app', 'ember-sugar/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('ember-sugar/tests/unit/controllers/login-page-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('ember-sugar/tests/unit/routes/deletelead-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | deletelead', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('ember-sugar/tests/unit/routes/insertlead-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | insertlead', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:insertlead');
      assert.ok(route);
    });
  });
});
define('ember-sugar/tests/unit/routes/leads-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | leads', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:leads');
      assert.ok(route);
    });
  });
});
define('ember-sugar/tests/unit/routes/login-page-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | login-page', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
require('ember-sugar/tests/test-helper');
